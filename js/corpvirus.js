document.addEventListener('DOMContentLoaded', () => {
    ...
    function createViirus(id) {
        ...
        img.src = 'Images/viruus-bleu.png';
        img.id = `viirus-${id}`;
        ...
        do {
            ...
            viirusRect = {
                left: posLeft,
                top: posTop,
                right: posLeft + viirusSize,
                bottom: posTop + viirusSize
            };

        } while (viirusRect.right > globuleRect.left &&
        viirusRect.left < globuleRect.right &&
        viirusRect.bottom > globuleRect.top &&
        viirusRect.top < globuleRect.bottom);
